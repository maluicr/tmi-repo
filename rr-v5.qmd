...
Para a estrutura temporal especificou-se um passeio aleatório (*random walk*) de primeira ordem com erros aleatórios gaussianos $\varepsilon \sim \text{N}(0,\sigma^2)$ e uma precisão elevada (i.e. desvio padrão reduzido):
